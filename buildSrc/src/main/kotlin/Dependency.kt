object Dependency {
    ...
    object BuildPlugin {
        const val ANDROID_GRADLE = "com.android.tools.build.gradle:${Version.android_plugin}"
        ...
        const val HILT = "com.google.dagger.hilt-android-gradle-plugin.versions:${Version.hilt_android}"
    }
